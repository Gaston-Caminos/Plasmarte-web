const datosPlasmarte = {
    ...
    obras: [
        ...
        },
        {
            ...
            descripcion: "A lo largo de mi experiencia como clown, he realizado visitas sociales a diversos establecimientos. Hogares de niños judicializados, centros de día y también geriátricos, entre otros. Debo destacar con mucho dolor en el alma que, en los geriátricos, y aclaro que no en todos los casos, he podido observar un denominador común en ellos: el olvido. Las miradas perdidas, las ilusiones desgastadas y el sentimiento de abandono flotan en la triste pero real atmosfera de estas instituciones. La obra con el título 'La Eterna Espera Del Olvido', pretende entonces reflejar y llevarnos a la reflexión de lo que podemos generar en nuestros viejos con el abandono y el olvido. En la obra, un anciano espera frente a una puerta cerrada deseando que se abra pronto.<br> Su deseo es que, al abrirla, sea el rostro de algun ser querido el primero en aparecer. En su mano derecha carga una valija. La ha preparado con el mismo entusiasmo que un niño de tres años tiene al preparar la suya cuando le anuncian que se ira de vacaciones. En la valija el anciano puede llevar tan sólo algunos objetos, pero que son para él en ese instante, todo el patrimonio que tiene. <br> La indignidad del destierro le hace sentir que han perdido todo. Las promesas estan hechas para cumplirse, pero lamentablemente en un gran porcentaje de las oportunidades, quienes las realizan faltan a su palabra quebrantandocon estos compromisos. Consecuencia de esto, un reloj antiguo en la esquina superior derecha de la puerta se ve viejo, oxidado y deteriorado por el tiempo que transcurre y transcurre. La espera se hace eterna, a tal punto que en el piso yace un fragmento del reloj. Para destacar y no siendo un dato menor, en el reloj el número cuatro está representado de la siguiente manera: IIII, cuando el número 4 en números romanos se escribe como 'IV'. Esto tiene una interesante explicación que argumenta y aumenta el sentimiento del paso del tiempo, ligada a la mitología romana y al Rey de Francia Luis XIV. La numeración romana proviene de la etrusca, y antes de que los romanos transformaran este sistema, el número cuatro se escribía como: IIII. Los etruscos o tirrenos fueron un pueblo de la Antigüedad cuyo núcleo geográfico fue la Toscana (Italia). Los primeros indicios de una cultura identificable como etrusca datan de alrededor del año 900 a.C. Incluso mucho después de quelos romanos habían definido su nuevo sistema de numeración, fueron varios los que siguieron utilizando el IIII. Sucede que en latín IV corresponde a las dos primeras letras del Dios Júpiter (IVPITER), consideraban entonces los romanos que era impropio su utilización para referirse a un número. Un dato de color histórico cuenta que el rey de Francia Luis XIV, mandó a construir un reloj para el Palacio de la Cité en París,lugar de residencia de los reyes de Francia. Cuando el relojero termino su trabajo y lo presentó al rey, éste lo recriminó por su mal trabajo argumentando que el numero 4 estaba mal escrito, que en vez de colocar IIII, había puesto en la versión romana IV. El relojero intento explicar que no lo había escrito de esa manera por respeto al dios Júpiter y que estaba equivocado, el rey automáticamente le respondió… 'El Rey Nunca se equivoca', y le ordenó cambiarlo. Los rumores de que el rey mandó ejecutarlo, hicieron que la mayoría de los colegas relojeros adaptasen esta modalidad de escribir el numero 4 como IIII hicieron que la mayoría de los colegas relojeros adaptasen esta modalidad de escribir el numero 4 como IIII",
        ...
        },
        {
            ...
            descripcion: "Esta es una obra que nace de la pura inspiración del artista donde dejandose llevar solo por la pasión y la intuición, logra conectarse con los pinceles cargados de la pulsión que lleva impresa la obra. También se utilizó una espatula pequeña que ayudo a dejar las marcas del trazo espontaneo del artista.",
            formatoVisual: "item-h",
            ano: "2025",
            dimensiones: "100x100 cm"
        },
        ...
        },    
        {
            ...
            descripcion: "Casita realizada en base a cartón y la técnica de <strong>cartapesta</strong>. Se utilizaron diversos materiales para su recubierta, entre ellos, piedritas de las que se colocan en las peceras.",
            formatoVisual: "item-v",
            ano: "2025",
            dimensiones: "100x100 cm"
        },
        ...
        },
        {
            ...
            descripcion: "Mural realizado en el frente de mi casa. No siempre nuestros heroes fueron reconocidos. Por mucho tiempo se los hizo a un lado dejándolos en el olvido. Como cualquier artista argentino, siempre tuve la necesidad de pintar sobre malvinas, y como para todo siempre hay un momento justo, decidi hacer este humilde mural que representa la participación de nuetros hermanos, el sufrimiento, la valentía y el honor de nuestros soldados.",
            formatoVisual: "item-h",
            ano: "2025",
            dimensiones: "100x100 cm"
        },
        {
            ...
            descripcion: "Mural para promoción de toque humorístico. Con la intención de difundir mi trabajo. Animo a que se saquen una fotografía y etiqueten a <strong>Plasmarte Aerografía</strong>.",
            formatoVisual: "item-v",
            ano: "2025",
            dimensiones: "100x100 cm"
        },
        ...
        },
        {
            ...
            descripcion: "La lealtad entre los elefantes es uno de los lazos sociales mas fuertes del reino animal. Estos animales  estructuran sus vidas en manadas matriarcales muy unidas, donde el cuidado mutuo, la protección y la empatía son fundamentales para la supervivencia del grupo.",
            formatoVisual: "item-v",
            ano: "2025",
            dimensiones: "100x100 cm"
        },
